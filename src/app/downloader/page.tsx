...
export default function SnapTubeTray() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-600 via-pink-500 to-red-500">
            ...
            <div>
              ...
              <div className="bg-white rounded-2xl shadow-2xl p-6 mb-6">
                ...
                <div className="flex gap-2 mb-4">
                  <input
                    ...
                    placeholder="Paste video URL here (YouTube, Facebook, Instagram...)"
                    className="flex-1 px-4 py-3 border-2 border-gray-300 rounded-xl focus:outline-none focus:border-purple-500 text-gray-700 placeholder:text-gray-400"
                  ...
                  <div className="border-t pt-4 mt-4">
                    ...
                    <div className="space-y-1">
                      {searchHistory.slice(0, 3).map((historyUrl, idx) => (
                        <button
                          key={idx}
                          onClick={() => useHistoryUrl(historyUrl)}
                ...
                <div className="bg-white rounded-2xl shadow-2xl p-6 mb-6">
                  <div className="flex gap-4 mb-6">
                    <div className="relative flex-shrink-0">
                      ...
                      <div className="absolute bottom-2 right-2 bg-black bg-opacity-75 text-white text-xs px-2 py-1 rounded font-bold">
                        {videoInfo.duration}
                      </div>
                      <div className="absolute top-2 left-2 bg-purple-600 text-white text-xs px-2 py-1 rounded font-bold">
                        {videoInfo.platform}
                      </div>
                    </div>
                    <div className="flex-1">
                      ...
                      <div className="flex gap-2 mt-3">
                        ...
                        <button className="text-gray-600 text-sm font-medium hover:underline flex items-center gap-1">
                          <Share2 size={14} />
                          Share
                        </button>
                      </div>
                  ...
                  <div className="space-y-3">
                    ...
                    {videoInfo.formats.map((format) => (
                      <div
                        key={format.id}
                        className="flex items-center justify-between p-4 bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl hover:from-purple-50 hover:to-pink-50 transition-all border border-gray-200 hover:border-purple-300 hover:shadow-md"
                      >
                        ...
                        <button
                          ...
                          className="bg-gradient-to-r from-purple-600 to-pink-600 text-white px-6 py-3 rounded-lg font-medium hover:shadow-lg transition-all flex items-center gap-2 hover:scale-105"
                        >
                          <Download size={18} />
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                {[
                  ...
                  <div
                    key={idx}
                    className={`bg-gradient-to-br ${feature.color} rounded-2xl p-5 text-white shadow-lg hover:scale-105 transition-transform cursor-pointer`}
                  >
              ...
              <div className="bg-white bg-opacity-20 backdrop-blur-lg rounded-2xl p-6 text-white">
                ...
                <ol className="space-y-2 text-sm">
                  <li className="flex gap-2">
                    ...
                    <span>Copy video URL from any supported platform</span>
                  </li>
                  <li className="flex gap-2">
                    <span className="font-bold">2.</span>
                    <span>Paste the URL in search box above</span>
                  </li>
                  <li className="flex gap-2">
                  ...
                  <li className="flex gap-2">
                    ...
                    <span>Click download and enjoy offline! 🎉</span>
                  </li>
                </ol>
              </div>
            </div>
              ...
              {downloads.length === 0 ? (
                <div className="text-center py-16 text-gray-400">
                  ...
                  <button
                    ...
                    className="mt-4 bg-gradient-to-r from-purple-600 to-pink-600 text-white px-6 py-2 rounded-lg font-medium hover:shadow-lg transition-all"
                  >
                    Browse Videos
                  </button>
                </div>
                ...
                <div className="space-y-4">
                  {downloads.map((download) => (
                    <div
                      key={download.id}
                      className="border-2 border-gray-200 rounded-xl p-4 hover:border-purple-300 transition-all hover:shadow-lg"
                    >
      ...
      {/* Bottom Navigation */}
      <div className="fixed bottom-0 left-0 right-0 bg-white shadow-2xl border-t z-20">
        <div className="max-w-4xl mx-auto flex justify-around py-3">
          {[
            ...
            <button
              ...
              className={`relative flex flex-col items-center gap-1 px-8 py-2 rounded-xl transition-all ${
                activeTab === tab.id
